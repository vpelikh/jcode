...
pub(super) use super::commands_review::{
    ...
    launch_prompt_in_new_session_local, maybe_enter_review_loop, maybe_poll_review_loop_from_idle,
...
pub(super) fn disable_auto_poke(app: &mut App) -> usize {
    ...
    app.todo_ownership_gate_attempts = 0;
    app.todo_ownership_gate_fingerprint = None;
    app.todo_confidence_gate_attempts = 0;
    app.todo_confidence_gate_fingerprint = None;
