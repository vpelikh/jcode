...
pub(super) fn emit_lifecycle_event(
    ...
    let state = {
        ...
        let state = match guard.as_ref() {
            Some(s) => SessionTelemetry {
                ...
                todo_gate_tradeoff_count: s.todo_gate_tradeoff_count,
    ...
    let event = SessionLifecycleEvent {
        ...
        todo_gate_tradeoff_count: state.todo_gate_tradeoff_count,
...
pub(super) fn todo_session_event(
    ...
    TodoSessionEvent {
        ...
        trade_off_min: todo.trade_off.min,
        trade_off_mean: todo.trade_off.mean,
        trade_off_count: todo.trade_off.count,
